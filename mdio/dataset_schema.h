...
The project build is configured to use the fetch and install it 3rd party dependencies.
...
- **Milestones**:
  - <span style="color:green">✔</span> Resolve high-importance defects (e.g., "Fix nghttp2 dependency").
  - <span style="color:green">✔</span> Complete critical updates to test suites.
  - <span style="color:green">✔</span> Address issues causing undefined behavior or potential crashes (e.g., "Variable schematization").
...
- **Milestones**:
  ...
  - Streamline data management processes to reduce storage or compute costs (e.g. "SEGY", "SEP" I/O).
